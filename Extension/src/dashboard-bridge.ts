...
logger.log('[Chat2Deal Extension] Dashboard bridge initialized', EXTENSION_VERSION)
logger.log('[Chat2Deal Extension] Listening for messages on:', window.location.href)
logger.log('[Chat2Deal Extension] Allowed origins:', ALLOWED_ORIGINS)

/**
 * Message listener for extension detection pings
 */
window.addEventListener('message', (event: MessageEvent) => {
  logger.log('[Chat2Deal Extension] Received message:', {
    origin: event.origin,
