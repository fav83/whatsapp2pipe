  ...
  return (
    <div className="space-y-3">
      <button
        onClick={onClick}
        disabled={isLoading}
        className="w-full px-4 py-3 bg-brand-primary text-white text-sm font-medium rounded-lg hover:bg-brand-hover disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
