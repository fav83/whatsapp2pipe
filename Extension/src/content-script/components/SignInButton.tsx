  ...
  return (
    <div className="space-y-3">
      <button
        onClick={onClick}
        disabled={isLoading}
        className="w-full px-4 py-3 bg-[#1483EB] text-white text-sm font-medium rounded-lg hover:bg-[#0d6fd1] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
